<template>
    <div class="family-container">
      ...
      <div v-if="selectedRecipe !== null" class="modal-overlay" @click="closeRecipeDetails">
        <div class="modal-content" @click.stop>
          ...
          <p><strong>Made by:</strong> {{ selectedRecipe.madeBy }}</p>
          <p><strong>Occasion:</strong> {{ selectedRecipe.occasion }}</p>
          <h3>Ingredients:</h3>
          <ul class="modal-list">
  ...
  .modal-title {
    ...
    flex-grow: 1; /* Allow the title to take space and be centered */
  }
